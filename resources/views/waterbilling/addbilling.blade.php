                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12"> <!--ml-12-->
                                ...
                                <form action="/index" method="POST">
                                    @csrf
                                    <label for="sec1">Meter Number:</label>
                                    <input type="text" id="lastname" name="meternum">
